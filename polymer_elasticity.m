...
str = {'Ks Fit:', ['Means the fitted Segment Elasticity of the investigated ' ...
    'Molecule.']};
UtilityFunctions.textLine(terminology_container, str,...
    'fontAngle', 'normal',...
    'fontWeight', 'normal',...
...
str = {'Lc Fit:', ['Means the fitted Contourlength of the investigated ' ...
    'Molecule.']};
UtilityFunctions.textLine(terminology_container, str,...
    'fontAngle', 'normal',...
    'fontWeight', 'normal',...
...
str = {'lk Fit:', ['Means the fitted Kuhnlength of the investigated ' ...
    'Molecule.']};
UtilityFunctions.textLine(terminology_container, str,...
    'fontAngle', 'normal',...
    'fontWeight', 'normal',...
...
str = {'Rupture Length:', ['"Lc Fit" + x-offset; means the Position of the ' ...
...
str = {'Xl:', 'Left Border of the Fitrange in %.'};
UtilityFunctions.textLine(terminology_container, str,...
    'fontAngle', 'normal',...
    'fontWeight', 'normal',...
    'horizontalAlignment', 'left');

str = {'Xr:', 'Right Border of the Fitrange in %.'};
UtilityFunctions.textLine(terminology_container, str,...
    'fontAngle', 'normal',...
    'fontWeight', 'normal',...
    'horizontalAlignment', 'left');

str = {'Distance:', 'Distance between Xl and Xr (Xr-Xl) in %.'};
